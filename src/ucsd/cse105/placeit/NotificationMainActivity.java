...
public class NotificationMainActivity extends Activity {
 ...
 public void sendBasicNotification() {
  Notification notification = new Notification.Builder(this)
    ...
    .setSmallIcon(R.drawable.common_signin_btn_icon_dark).build();
 ...
 public void sendBigTextStyleNotification(View view) {
  ...
  builder.setContentTitle("Big text Notofication")
    ...
    .addAction(R.drawable.common_signin_btn_icon_disabled_dark, "show activity", pi);
 ...
 public void sendBigPictureStyleNotification(View view) {
  ...
  builder.setContentTitle("BP notification")
    ...
    .addAction(R.drawable.ic_plusone_small_off_client, "show activity", pi)
    .addAction(
  ...
  Notification notification = new Notification.BigPictureStyle(builder)
    .bigPicture(
      BitmapFactory.decodeResource(getResources(),
        R.drawable.common_signin_btn_icon_dark)).build();
 ...
 public void sendInboxStyleNotification(View view) {
  ...
  Builder builder = new Notification.Builder(this)
    ...
    .setSmallIcon(R.drawable.ic_launcher)
    .addAction(R.drawable.common_signin_btn_icon_dark, "show activity", pi);
